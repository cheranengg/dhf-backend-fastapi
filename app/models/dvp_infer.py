...
# tokenizer from base (fast->slow fallback); weights from merged repo
def _load_tokenizer():
...
def _load_model():
    ...
    _model = AutoModelForCausalLM.from_pretrained(DVP_MODEL_DIR, torch_dtype=dtype, **_token_cache_kwargs())
